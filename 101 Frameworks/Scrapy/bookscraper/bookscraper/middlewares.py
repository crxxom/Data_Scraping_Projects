...
# This middleware only fakes a user-agent
class ScrapeOpsFakeUserAgentMiddleware:

    @classmethod
    def from_crawler(cls, crawler):
        return cls(crawler.settings) #make sure we have access to the settings.py
    ...
    # create a list of random user agent based on the num_results set
    ...
    # One of the functions scrapy will look for when you use middleware, the name matters! This function just set the headers to the headers of random_user_agent
    def process_request(self, request, spider):        
...
# This middleware does more than just faking user-agent, it also fake a lot more requests in the request header
